<footer class="footer-area" style="background-image:url(<?=$cdn_domaine?>/assets/images/footer-bg.png)">
    <div class="container">
        <div class="row">
            ...
            <div class="col-md-4">
                    <div class="widget-title-area">
                        <h3 class="widget-title">Liens utils</h3>
                    </div>
                    <ul>
        ...
        <div class="row">
            <div class="col-md-6">
                <div class="bottom-content footer">
                    <p class="m-0">Copyright  &copy; 2023 CCGIM </p>
                </div>
            </div>
            <div class="col-md-6">
                <div class="bottom-content footer">
                    <p class="m-0 text-right">Designed and Developed by <a href="https://makompe.com/" target="_blank" style="text-decoration: none">Makompe Communication</a></p>
                </div>
            </div>
        </div>
    </div>
...
<script src="<?=$cdn_domaine?>/assets/libs/datatable/datatables.min.js"></script>
<script src="<?=$cdn_domaine?>/assets/libs/wow/wow.js"></script>
<script>
    wow = new WOW(
        {
