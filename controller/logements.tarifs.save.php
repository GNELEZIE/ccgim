<?php
if(isset($_SESSION['_ccgim_201'])  and isset($_POST['prix_regulier'])  and isset($_SESSION['myformkey']) and isset($_POST['formkeyTarifs']) and $_SESSION['myformkey'] == $_POST['formkeyTarifs']){
    extract($_POST);
